...
# Guideline Q&A pipeline. Step 1 logic is unchanged from v4 — the v6
# rewrite replaced the 3-layer retrieval stack (content_retriever +
# knowledge_loader dispatcher + atom_retriever) with a single unified
# scoring function in retrieval.py. Classification upstream was correct.
# ───────────────────────────────────────────────────────────────────────
"""
