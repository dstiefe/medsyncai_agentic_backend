...
def _build_system_prompt(schema: str, synonym_data: dict,
    ...
    primacy = (
        ...
        "6. Anchor vocabulary — clinical terms from the guideline for "
        "anchor_terms extraction\n\n"
        "**You MUST consult all six before classifying.** Your first pass "
        "on any question is to look it up in these references:\n"
        "- Does the question match an intent in the intent guide? Pick it.\n"
        "- Does the question name a topic in the topic map? Classify there.\n"
