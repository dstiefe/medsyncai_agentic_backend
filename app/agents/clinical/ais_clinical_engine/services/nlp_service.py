                ...
                tools=[
                    {
                        ...
                        "input_schema": {
                            ...
                            "properties": {
                                ...
                                "recentDOAC": {"type": ["boolean", "null"], "description": "true if user reports the patient took a direct oral anticoagulant (DOAC — apixaban, rivaroxaban, dabigatran, edoxaban) within the past 48 hours. false if explicitly ruled out / last DOAC dose >48h ago. null if DOAC use timing not specified."}
                            },
                            "required": []
                        }
                    }
