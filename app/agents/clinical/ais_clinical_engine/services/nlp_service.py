        ...
        try:
            response = self.client.messages.create(
                ...
                system=(
                    ...
                    "YOUR ROLE: You SUMMARIZE the guideline content. You do NOT interpret, "
                    "paraphrase, or add to it. Every claim in your answer must be traceable "
                    "to a specific line in the provided text.\n\n"
                    ...
                    "- Do NOT list specific examples (drugs, devices, agents, trials) unless they "
                    "are explicitly named in the provided text. If the guideline says 'neuroprotective "
                    "treatments are not recommended' without listing specific agents, do NOT add "
                    "examples from your own knowledge.\n"
                    "- COR and LOE values MUST be copied exactly from the provided text. "
                    "Do NOT change, round, or upgrade them. If the text says COR 2a, you MUST "
                    "say COR 2a — never COR 1 or COR 2. If it says COR 3:No Benefit, say exactly "
                    "that — never just COR 3.\n"
                    ...
                    "- Preserve temporal qualifiers. If the guideline says 'At present' or "
                    "'currently', include them — they signal the evidence may evolve. Dropping "
                    "them overstates the finality of the recommendation.\n"
                    ...
                    "- When recommendations apply to DIFFERENT patient populations or have different "
                    "scopes (e.g., 'all suspected stroke patients' vs 'patients with suspected LVO'), "
                    "CLEARLY state which recommendation applies to whom. Do NOT blend universal "
                    "recommendations with subset-specific ones — a clinician must be able to tell "
