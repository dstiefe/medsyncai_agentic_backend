...
- **other** — greetings, thank-you messages, off-topic questions, scope questions, or anything that does not fit equipment or clinical.
...
```json
{
  "domain": "equipment" | "clinical" | "other",
  "confidence": 0.0-1.0
}
```
